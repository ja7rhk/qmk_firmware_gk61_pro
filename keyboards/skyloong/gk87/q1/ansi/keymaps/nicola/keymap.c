...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] =  LAYOUT_all(
     ...
     [_NICOLA] =  LAYOUT_all(
        KC_ESC,             KC_F1,    KC_F2,    KC_F3,    KC_F4,       KC_F5,    KC_F6,     KC_F7,     KC_F8,      KC_F9,     KC_F10,   KC_F11,   KC_F12,   LCTL(KC_0),
        KC_GRV,   NG_1,     NG_2,     NG_3,     NG_4,     NG_5,        NG_6,     NG_7,      NG_8,      NG_9,       NG_0,      NG_MINS,  NG_EQL,   KC_BSPC,  KC_PSCR,  KC_HOME,  KC_PGUP,
    ...
    [_FUNC] =  LAYOUT_all(
        _______,            KC_F13,   KC_F14,   KC_F15,   KC_F16,      _______,   _______,   _______,  _______,    _______,   _______,  _______,  _______,  RM_TOGG,
        ...
        _______,  _______,  _______,  _______,  _______,  _______,     _______,   KC_PSCR,   _______,  _______,    _______,   RM_TOGG,  RM_PREV,  RM_NEXT,  KC_DEL,   KC_END,   KC_PGDN,
        ...
        _______,  _______,  _______,            KC_DEL,   _______,                KC_ESC,              _______,    _______,   _______,            _______,  RM_SPDD,  RM_VALD,   RM_SPDU
    )
};
